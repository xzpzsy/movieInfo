package cn.edu.seu.xzp.movie.jdbc;

import cn.edu.seu.xzp.movie.conf.ConfigurationManager;
import cn.edu.seu.xzp.movie.constant.Constants;
...
public class JDBCHelper {
	...
	// 或者是DB2、SQLServer
	// 那么，就必须很费劲的在代码中找，找到硬编码了com.mysql.jdbc.Driver的地方，然后改成
	// 其他数据库的驱动类的类名
	...
	public int executeUpdate(String sql, Object[] params) {
		...
		PreparedStatement pstmt = null; //sql语句的执行句柄
	...
	public static interface QueryCallback {
		 ...
		 * @throws Exception
		 */
		List<Map<String, Object>> process(ResultSet rs) throws Exception;
